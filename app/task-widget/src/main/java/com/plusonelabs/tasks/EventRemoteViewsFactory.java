...
import com.plusonelabs.tasks.calendar.CalendarEventVisualizer;
import com.plusonelabs.tasks.widget.DayHeader;
...
import static com.plusonelabs.tasks.CalendarIntentUtil.createOpenCalendarAtDayIntent;
import static com.plusonelabs.tasks.CalendarIntentUtil.createOpenCalendarEventPendingIntent;
import static com.plusonelabs.tasks.RemoteViewsUtil.setBackgroundColor;
import static com.plusonelabs.tasks.RemoteViewsUtil.setBackgroundColorFromAttr;
import static com.plusonelabs.tasks.RemoteViewsUtil.setPadding;
import static com.plusonelabs.tasks.RemoteViewsUtil.setTextColorFromAttr;
import static com.plusonelabs.tasks.RemoteViewsUtil.setTextSize;
import static com.plusonelabs.tasks.Theme.getCurrentThemeId;
import static com.plusonelabs.tasks.prefs.CalendarPreferences.PREF_DAY_HEADER_ALIGNMENT;
import static com.plusonelabs.tasks.prefs.CalendarPreferences.PREF_DAY_HEADER_ALIGNMENT_DEFAULT;
...
public class EventRemoteViewsFactory implements RemoteViewsFactory {
	...
	private RemoteViews getRemoteView(DayHeader dayHeader) {
        ...
        rv.setTextViewText(R.id.day_header_title, "TASKS");
